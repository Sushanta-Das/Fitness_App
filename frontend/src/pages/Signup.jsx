...
function Signup() {
    ...
    return (        
        <div>
            ...
            Age (in years): <input type="number" step="0.1" onChange={(e) => { setAge(e.target.value) }} /> <br />
            Height (in feet): <input type="number" step="0.1" onChange={(e) => { setHeight(e.target.value) }} /> <br />
            Weight (in kg): <input type="number" step="0.1" onChange={(e) => { setWeight(e.target.value) }} /> <br />
